...
public class SearchDialogFragmetn extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final View v = inflater.inflate(R.layout.search_dialog_content, null);
        ...
        builder.setView(v).
            ...
            public void onClick(DialogInterface dialog, int id) {
                SearchDialogFragmetn.this.getDialog().cancel();
            }
        });
